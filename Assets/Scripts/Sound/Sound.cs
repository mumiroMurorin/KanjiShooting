...
namespace SoundManager {
	...
	public class Sound : MonoBehaviour {
		...
		[SerializeField, Tooltip("SEAudioMixer")] protected AudioMixerGroup audioMixerGroupSe = null;
		[SerializeField, Tooltip("BGMAudioMixer")] protected AudioMixerGroup audioMixerGroupBgm = null;
		...
		protected virtual void Awake () {
			...
			for (var i = 0; i < seSource.Length; i++) {
				...
				if (audioMixerGroupSe != null) { seSource[i].outputAudioMixerGroup = audioMixerGroupSe; }
			}
			...
			for (var i = 0; i < smSource.Length; i++) {
				...
				if (audioMixerGroupBgm != null) { smSource[i].outputAudioMixerGroup = audioMixerGroupBgm; }
			}
